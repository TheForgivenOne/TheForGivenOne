              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-center gap-3 sm:gap-4 group">
                    <div className="icon-hover w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-[#111118] border border-[#00d4ff]/20 flex items-center justify-center text-[#00d4ff] group-hover:border-[#00d4ff] group-hover:glow-border transition-all flex-shrink-0">
                  ...
                  <div className="flex gap-3 sm:gap-4">
                    {socialLinks.map((link) => (
                      <a
                        ...
                        className="social-hover w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-[#111118] border border-[#00d4ff]/20 flex items-center justify-center text-[#888899] hover:text-[#00d4ff] hover:border-[#00d4ff] transition-all duration-300"
